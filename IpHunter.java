...
public class IpHunter extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String a =new String(new byte[]{83,111,99,107,115,72,84,84,80,45,73,80,32,72,117,110,116,101,114,});
		xLItems.add(a);
        xAdapter = new ArrayAdapter<String>(this,
											R.layout.list_text,xLItems);
        xLv.setAdapter(xAdapter);
		String b = new String(new byte[]{70,97,103,109,109,109,117,32,67,111,100,101,32,83,101,99,116,111,114,45,40,70,67,83,41,});
